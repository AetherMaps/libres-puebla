...
map.getView().fit([-10886795.878569, 2197969.238589, -10857993.670290, 2218916.365442], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Localidades, Vulnerabilidad Acuífera y Morfología del Terreno en Libres, Puebla</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (232 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visualiza localidades, vulnerabilidad acuífera y curvas de nivel. Permite explorar asentamientos y zonas de riesgo hídrico de manera interactiva. <br /><br />Fuente de datos: WMS-INEGI, 2021<br /><br />Elaboró: Brenda Soto Rivera <br />11 de noviembre, 2025';
            }
